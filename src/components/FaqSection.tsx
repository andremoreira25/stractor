...
const faqs = [
  ...
  { q: "Os implementos já estão inclusos no serviço do Trator?", a: "Sim. Já estão inclusos todos os implementos necessários para a realizar aração, gradeamento, abertura de sulcos, produção de silagem, distribuição de calcário, roçagem de pastagens e muito mais." },
